...
$edit= mysql_query('SELECT * FROM shoppingreinounido WHERE id='.$cod);

$loc=mysql_fetch_array($edit);

?>
<body style="background-image: url(fondo1.jpg)">
<form action="editar_guardarshoppingreinounido.php" method="POST">
...
<br>
<br>
<a href="/pagina%20web%20juan%20camilo%20pabon/shoppingreinounido/shoppingreinounido.php">
