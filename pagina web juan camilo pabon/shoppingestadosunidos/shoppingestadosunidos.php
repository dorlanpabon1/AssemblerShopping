...
$consulta=mysql_query('SELECT * FROM shoppingestadosunidos');
...
<script type="text/javascript" src="../js/jquery-2.1.4.min.js"></script>
	<script type="text/javascript" src="../js/shoppingestadosunidos.js"></script>
	<style type="text/css">
	div{
		border-radius: 5px;
...
<h1> Paginas de Compras en Estados Unidos</h1>
...
<tr>
	...
	<td><a href="editar/editar_shoppingestadosunidos.php?codigo=<?php echo $filas['id']?>"><img src="editar.jpg"></a>
...
<a href="nuevo/nuevo_shoppingestadosunidos.php" style="float:left"><img src="nuevo.jpg"><br> Nuevo</a>
</div>
</div>
</div>
</center>
